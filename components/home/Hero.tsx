      ...
      <div className="max-w-[73rem] mx-auto px-6 grid grid-col-1 md:grid-col-2 md:gap-x-28">
        <div>
          ...
          <div className="mb-2 md:mb-0">
            ...
            <div>
              <p className="mb-4 text-[#595f75] text-base md:text-lg md:w-3/4 sm:pb-7">
              ...
              <div className="max-w-[20.1875rem]">
                <button className="cursor-pointer bg-[#7357f6] text-white text-base rounded-full font-bold w-full max-w-[20.1875rem] h-[3.9375rem] hover:bg-[#634cca] transition delay-300 duration-75 ease-in-out relative">
                  ...
                  <Image
                    ...
                    width={52}
                    height={70}
                    className="absolute -top-20 right-0 sm:-right-16 sm:-top-10"
                    priority
                  />
                </button>
        ...
        <div className="mx-auto relative sm:col-start-2 sm:mt-5 w-full md:w-[23.375rem] h-[17.5625rem] sm:h-[36.75rem]">
          <div className="absolute bottom-0 w-full h-full sm:static">
            {/* Desktop */}
            <Image
              src={
