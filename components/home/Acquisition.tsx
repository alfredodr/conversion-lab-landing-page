...
const Acquisition = () => {
  return (
    <section className="bg-[#f2f8f6]">
      <div className="max-w-[70rem] h-full sm:mx-auto px-6 lg:px-0 lg:pt-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 sm:gap-10">
          <div className="lg:order-last  mb-10 lg:mb-0">
            <h2
              className={`text-[#343b55] ${dmSerifText.variable} font-dmSerifText my-5`}
            >
              Expect increase in conversion rates with targeted landing pages
            </h2>

            <p className="text-[#595f75] text-lg sm:text-base mb-4">
            ...
            <p className="text-[#595f75] text-lg sm:text-base">
          ...
          <div className="flex">
            <div className="relative">
              ...
              <Image
                ...
                width={322}
                height={453}
                className="z-10 hidden sm:block relative"
              />
              {/* Mobile */}
              <Image
                src={
                ...
                width={234}
                height={330}
                className=" z-10 block sm:hidden relative"
              />

              <div className="bg-white absolute -top-6 -right-10 sm:-right-24 sm:-top-12 rounded-md">
                <div className="p-2 sm:p-3">
                  <span className="text-xs sm:text-sm font-bold absolute top-2 left-24 sm:top-10 sm:left-16">
                    +34% CVR
                  </span>
                  {/* Desktop */}
                  <Image
              ...
              <div className="absolute top-28 -right-20 sm:-right-40 sm:top-36">
                {/* Desktop */}
                <Image
                  src={
